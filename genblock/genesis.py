...
def create_transaction(input_script, output_script):
  ...
  #tx.out_value         = struct.pack('<q' ,0x00005AF3107A4000) #1000000 coins
  #tx.out_value         = struct.pack('<q' ,0x0011C37937E08000) #50000000 coins
  tx.out_value         = struct.pack('<q' ,0x00038D7EA4C68000) #10000000 coins
