...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Coolcash");
    case mBTC: return QString("Milli-Coolcash (1 / 1,000)");
    case uBTC: return QString("Micro-Coolcash (1 / 1,000,000)");
    default: return QString("???");
    }
}
