...
public:
    enum
    {
        PUBKEY_ADDRESS = CONF_PUBKEY_ADDRESS,
        SCRIPT_ADDRESS = CONF_SCRIPT_ADDRESS,
        PUBKEY_ADDRESS_TEST = CONF_PUBKEY_ADDRESS_TEST,
        SCRIPT_ADDRESS_TEST = CONF_SCRIPT_ADDRESS_TEST
    };
