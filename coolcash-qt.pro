TEMPLATE = app
TARGET = coolcash-wallet
macx:TARGET = "coolcash-wallet"
VERSION = 0.8.7.2
INCLUDEPATH += src src/json src/qt src/qt/forms
QT += core gui network
...
macx:ICON = src/qt/res/icons/coolcash.icns
